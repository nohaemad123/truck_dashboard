...
import { HowJoin, Table_Coloumns } from '../models/how-join';
...
@Component({
  selector: 'app-all-how-join',
  templateUrl: './all-how-join.component.html',
  styleUrls: ['./all-how-join.component.scss']
})
export class AllHowJoinComponent implements OnInit {
