...
export class AllNotificationsComponent implements OnInit {
  ...
  showNotficationsForUser(){
    if(this.userId<=0 || !this.userId){
      this.toastr.warning("اختر مستخدم لعرض الاشعارات ", "", {
  ...
  getAllNotificationsForUser(){
    ...
    this._httpService
      .get("/Notifications/GetAllNotificationByUserId", {UserId:this.userId,CountItems:this.ItemsPerpage, page: 1 }, false)
      .subscribe((res: any) => {
  ...
  getAllNotifications() {
    this.allNotifications = [];
    this._httpService
      .get("/Notifications/GetAllNotification", { CountItems:this.ItemsPerpage, page: 1 }, false)
      .subscribe((res: any) => {
        this.allNotifications = res;
  ...
  getAllUsers() {
    this.allUsers = [];
    this._httpService
      .get("/Users/GetAllUsers", { CountItems: 10000, page: 1 }, false)
      .subscribe((res: any) => {
  ...
  SendNotfication() {
    ...
    if (this.notifactionsForm.controls["userId"].value[0] === 0) {
      for (let index = 0; index < this.allUsers.length; index++) {
        arr.push(this.allUsers[index].id);
      }
