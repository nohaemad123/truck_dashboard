...
import { Table_Coloumns } from '../models/all-asubscriptioncost';
...
@Component({
  selector: 'app-all-asubscriptioncost',
  templateUrl: './all-asubscriptioncost.component.html',
  styleUrls: ['./all-asubscriptioncost.component.scss']
})
export class AllASubscriptioncostComponent implements OnInit {
  ...
  getAllUsers() {
    ...
    this._httpService.get('/Users/GetAllUsers',{CountItems:this.ItemsPerpage,page:1},false).subscribe((res: any) => {
      ...
      this.allQuestion.forEach((elem=>{
        elem.subscriptionAr='قيمه الاشتراك';
      elem.subscritpionType="6 شهور"
        elem.country="مصر",
