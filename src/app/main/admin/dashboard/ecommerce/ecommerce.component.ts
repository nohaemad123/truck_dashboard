...
import { locale as english } from 'app/main/admin/dashboard/i18n/en';
import { locale as french } from 'app/main/admin/dashboard/i18n/fr';
import { locale as german } from 'app/main/admin/dashboard/i18n/de';
import { locale as portuguese } from 'app/main/admin/dashboard/i18n/pt';
...
export class EcommerceComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this._httpService.get('/TruckData/GetAllStatistics',{},false).subscribe((res:any)=>{
      console.log('GetAllStatistics',res);
      this.statistics=res;
