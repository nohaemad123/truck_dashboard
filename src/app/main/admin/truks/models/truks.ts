...
export const Table_Coloumns: IColoumnType[] = [
  ...
  { title: "اسم العربة", type: 'avatar', data: { prop: 'truckName', src: 'truckImage', description: 'description' }, width: 80 },
  ...
  { title: "التوصيل داخل المدينة", type: 'text', data: { prop: 'deliveryPriceInsideCity', concatText: 'ريال' }, width: 43, },
  { title: "التوصيل خارج المدينة", type: 'text', data: { prop: 'deliveryPriceOutInsideCity', concatText: 'ريال' }, width: 40, },
  { title: "المدينة", type: 'text', data: { prop: 'cityName' }, width: 20, },

  { title: "نوع النشاط", type: 'text', data: { prop: 'businessName' }, width: 10, },
  { title: "التقيم", type: 'rate', data: { prop: 'trackRating' }, width: 15, },
  ...
  {
    title: "الاجراءات", type: 'actions', data: [{
      id: "id", name: 'edit', url: '/admin/Trucks/Edit'
      , iconTitle: "تعديل تراك"
    },
    { id: "id", name: 'delete', iconTitle: "حذف تراك" },
    { id: "id", name: 'view', Show: true, iconTitle: "تفاصيل التراك" }], width: 20
  },
]
...
export const small_columns: IColoumnType[] = [
  ...
  { title: "التقيم", type: 'rate', data: { prop: 'trackRating' }, width: 80 },
...

  {
    ...
    { id: "id", name: 'view', Show: true, iconTitle: 'عرض التراك', }]
