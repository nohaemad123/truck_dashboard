...
export const coreConfig: CoreConfig = {
  app: {
    appName     : 'Truck',                                        // App Name
    appTitle    : 'Truck Dashboard', // App Title
    appLogoImage: 'assets/images/logo/logowhite.svg',                // App Logo
    appLogoImageDark: 'assets/images/logo/logowhite.svg',       // App Logo
    appLanguage : 'ar',                                           // App Default Language (en, fr, de, pt etc..)
  },
  layout: {
    skin  : 'semi-dark',                        // default, dark, bordered, semi-dark
    type  : 'admin',                       // vertical, horizontal
