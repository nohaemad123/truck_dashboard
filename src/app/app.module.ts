...
import { EcommerceService } from './main/ecommerce/ecommerce.service';
import { AdminService } from './main/admin/admin.service';
import { EcommercesService } from './main/ecommerce/ecommerces.service';
import { AuthLayoutService } from './main/pages/authentication/auth-layout.service';
...
const appRoutes: Routes = [
  ...
  {
    path: 'ecommerce',
    loadChildren: () => import('./main/ecommerce/ecommerce.module').then(m => m.EcommerceModule),
    canActivate: [AuthGuard],
    resolve: {
      // EcommercesService
    }
